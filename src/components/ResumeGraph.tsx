...
import { MobileCompetencyMap } from "./MobileCompetencyMap";
import {
...
export function ResumeGraph() {
  ...
  return (
    <>
      {/* DESKTOP VIEW: SVG Interactive Network Graph (lg:block) */}
      <div
        ref={containerRef}
        onMouseMove={handleMouseMove}
        onMouseUp={handleMouseUpOrLeave}
        onMouseLeave={handleMouseUpOrLeave}
        className="hidden lg:block relative w-full h-[800px] bg-[#FFFDF8] border border-[#0F5132]/10 rounded-3xl overflow-hidden select-none"
      >
        {/* Subtle grid */}
      ...
      {/* MOBILE VIEW: MobileCompetencyMap Explorer (lg:hidden) */}
